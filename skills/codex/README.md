...
1. Ask which reasoning effort level (`low`, `medium`, or `high`) unless already specified in your prompt.
2. Select appropriate sandbox mode (defaults to `read-only` for analysis)
